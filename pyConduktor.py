...
CONFIG_DIR = platformdirs.user_config_dir("pyConduktor", ensure_exists=True)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="pyConduktor lets you connect HID/MIDI controllers and execute actions on control changes"
    )
